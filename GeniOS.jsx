...
function IntegrationsFlow() {
  ...
  // Brand icons  -  each renders in a 22x22 space at (x, y)
  ...
  // Robot icon (20x20) matching the uploaded design
  const robotIcon = (x, y) => (
...
function Footer() {
  ...
  <span style={{ fontFamily: T.mono, fontSize: 10, color: T.textDim, letterSpacing: "0.06em" }}>(c) 2026 GeniOS. All rights reserved.</span>
  </footer>
  );
}
